...
#   def connect(src, dst, id, length = 1)
...
#     end
#     @edges.push Edge.new(src, dst, id, length)
#   end
  
#   def connect_mutually(vertex1, vertex2, id, length = 1)
#     self.connect vertex1, vertex2, id, length
