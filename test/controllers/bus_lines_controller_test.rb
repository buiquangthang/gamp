...
class BusLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus_line" do
    assert_difference('BusLine.count') do
      post bus_lines_url, params: { bus_line: { description: @bus_line.description, in_charge_unit: @bus_line.in_charge_unit, name: @bus_line.name, operating_from: @bus_line.operating_from, operating_to: @bus_line.operating_to, ticket_fee: @bus_line.ticket_fee } }
    end
  ...
  test "should update bus_line" do
    patch bus_line_url(@bus_line), params: { bus_line: { description: @bus_line.description, in_charge_unit: @bus_line.in_charge_unit, name: @bus_line.name, operating_from: @bus_line.operating_from, operating_to: @bus_line.operating_to, ticket_fee: @bus_line.ticket_fee } }
