...
class DistancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distance" do
    assert_difference('Distance.count') do
      post distances_url, params: { distance: { busstop_from: @distance.busstop_from, busstop_to: @distance.busstop_to, distance_metter: @distance.distance_metter } }
    end
  ...
  test "should update distance" do
    patch distance_url(@distance), params: { distance: { busstop_from: @distance.busstop_from, busstop_to: @distance.busstop_to, distance_metter: @distance.distance_metter } }
